...
abstract class $RootRouter extends _i9.RootStackRouter {
  ...
  final Map<String, _i9.PageFactory> pagesMap = {
    ...
    RootWrapperRoute.name: (routeData) {
      return _i9.AutoRoutePage<dynamic>(
        routeData: routeData,
        child: _i9.WrappedRoute(child: const _i6.RootWrapperScreen()),
      );
    },
...
/// generated route for
/// [_i1.DevelopScreen]
class DevelopRoute extends _i9.PageRouteInfo<void> {
  const DevelopRoute({List<_i9.PageRouteInfo>? children})
      : super(
          DevelopRoute.name,
...
/// generated route for
/// [_i4.MoneyScreen]
class MoneyRoute extends _i9.PageRouteInfo<void> {
  const MoneyRoute({List<_i9.PageRouteInfo>? children})
      : super(
          MoneyRoute.name,
          initialChildren: children,
        );
...
/// generated route for
/// [_i3.MoneyTabPage]
class MoneyTab extends _i9.PageRouteInfo<void> {
  const MoneyTab({List<_i9.PageRouteInfo>? children})
      : super(
          MoneyTab.name,
          initialChildren: children,
        );
...
class RootWrapperRoute extends _i9.PageRouteInfo<void> {
  const RootWrapperRoute({List<_i9.PageRouteInfo>? children})
      : super(
